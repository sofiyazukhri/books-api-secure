...
final class AuthController { 
    ...
    public function register(Request $r, Response $s): Response { 
        // 🚀 COMBINE EVERYTHING: Read body parsing, raw input streams, AND browser URL parameters all at once!
        $b = array_merge(
    ...
    public function login(Request $r, Response $s): Response { 
        ...
        // 🚀 Bypasses all middleware stacks and stream pointers entirely
        if (empty($b)) {
